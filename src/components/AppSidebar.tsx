...
export const SUBJECT_PRESETS = [
  {
    icon: "🏫",
    subject: "১ম-৫ম শ্রেণি (প্রাথমিক বই)",
    desc: "NCTB বাংলা, গণিত, বিজ্ঞান, বিজিএস ও ইসলাম শিক্ষা",
    prompt: "১ম থেকে ৫ম শ্রেণির পাঠ্যবইয়ের এই বিষয়টি বুঝিয়ে দাও: ",
  },
  {
    icon: "📖",
    subject: "সপ্তবর্ণা (৭ম শ্রেণি বাংলা)",
    desc: "কাবুলিওয়ালা, লখার একুশে, পদ্যাংশ ও শব্দার্থ",
    prompt: "সপ্তবর্ণা (৭ম শ্রেণি বাংলা) বইয়ের এই পাঠটি বুঝিয়ে দাও: ",
  },
  {
    icon: "📐",
    subject: "গণিত",
